...
source: "https://github.com/safishamsi/graphify/blob/v5/docs/translations/README.zh-CN.md"
author:
published:
created: 2026-04-30
...
| 语料 | 文件数 | 压缩比 | 输出 |
| --- | --- | --- | --- |
| Karpathy 的仓库 + 5 篇论文 + 4 张图片 | 52 | **71.5x** | [`worked/karpathy-repos/`](https://github.com/safishamsi/graphify/blob/v5/docs/translations/worked/karpathy-repos) |
| graphify 源码 + Transformer 论文 | 4 | **5.4x** | [`worked/mixed-corpus/`](https://github.com/safishamsi/graphify/blob/v5/docs/translations/worked/mixed-corpus) |
| httpx（合成 Python 库） | 6 | ~1x | [`worked/httpx/`](https://github.com/safishamsi/graphify/blob/v5/docs/translations/worked/httpx) |
...
模块职责和新增语言的方法见 [ARCHITECTURE.md](https://github.com/safishamsi/graphify/blob/v5/docs/translations/ARCHITECTURE.md) 。